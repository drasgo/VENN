...
FRAMEWORKS = {"TensorFlow": "tensorflow", "PyTorch": "torch", "Keras": "keras"}
# , "FastAI": "fastai"}
...
BLOCK_LABELS_NO_IOFILE = ["DENSE", "POOLING", "DROPOUT", "CONV2D", "CONV3D"]


BLOCK_LABELS_YES_IOFILE = ["INPUT", "OUTPUT"]

BLOCK_LABELS_OTHERS = ["SUM", "MULT", "SUB", "CONC"]
...
LABELS_IN_BLOCK_STYLESHEET = (
    "border: 1px solid black;" "border-radius: 5px;" "font: 8pt 'Cantarell';"
)


STANDARD_LABELS_IN_BLOCK_STYLESHEET = (
    "border-color: rgb(114, 159, 207);" "font: 8pt 'Cantarell';"
)
